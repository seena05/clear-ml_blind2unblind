...
def validation_medical(dataset_dir):
...
# medical_dir = os.path.join(opt.test_dirs, "medical")
medical_dir = opt.test_dirs
valid_dict = {
    # "Kodak24": validation_kodak(Kodak_dir),
    # "BSD300": validation_bsd300(BSD300_dir),
    # "Set14": validation_Set14(Set14_dir)
    "medical": validation_medical(medical_dir)
}
